...
class GUI(tk.Frame):
    def __init__(self, root, geometry: Geometry, geometry_changed_callback, constraints, constraints_changed_callback, mainWindow, objective, nextFunction):
        ...
        # exitButton = tk.Button(MainWindowRoot, text= "Complete OLD_Sketch", command = self.endSketch)
    ...
    def create_top_menu(self):
        ...
        menubar.add_checkbutton(label="Complet OLD_Sketch", command=self.completeSketch)
    ...
    def create_icons(self):
        self.segment_icon = tk.PhotoImage(file =f"/OLD_Sketch\\icons\\{BUTTON_ICON_SIZE}x{BUTTON_ICON_SIZE}\\segment.png")
        self.arc_icon =     tk.PhotoImage(file =f"/OLD_Sketch\\icons\\{BUTTON_ICON_SIZE}x{BUTTON_ICON_SIZE}\\arc.png")
        self.circle_icon =  tk.PhotoImage(file =f"/OLD_Sketch\\icons\\{BUTTON_ICON_SIZE}x{BUTTON_ICON_SIZE}\\circle.png")
        ...
        for icon_size in icon_sizes:
            ...
            for constraint_type in CONSTRAINT_TYPE:
                self.constraint_icon[icon_size][constraint_type] = tk.PhotoImage(file =f"/OLD_Sketch\\icons\\{BUTTON_ICON_SIZE}x{BUTTON_ICON_SIZE}\\{icon_file_name[constraint_type]}.png")
