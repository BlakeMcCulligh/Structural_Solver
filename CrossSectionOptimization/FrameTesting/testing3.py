...
def run_full_dmo_frame_optimizer_multi_load():
    ...
    F1 = np.zeros(9)
    F1[7] = -10000
    load_cases.append(F1)

    F2 = np.zeros(9)
    F2[6] = 5000
    load_cases.append(F2)
...
result = run_full_dmo_frame_optimizer_multi_load()
