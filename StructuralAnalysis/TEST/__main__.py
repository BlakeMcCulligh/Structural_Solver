...
class Frame3D:
    ...
    def addMember(self, i_node: int, j_node: int, material_name: int, setCrossSectionProps: bool, A: float, Iy: float, Iz: float, J: float, rotation: float = 0.0):
        self.members.append([i_node, j_node, material_name, setCrossSectionProps])
        self.members_CrossSectionProps.append([A, Iy, Iz, J, rotation])
    ...
    #def preAnalysis_linear #TODO

    #def analysis_linear #TODO
