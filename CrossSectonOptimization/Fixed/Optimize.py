...
from CrossSectonOptimization.Fixed.CrossSectionCatalog import Catalog, CrossSection
#from CrossSectonOptimization.Fixed.SolveFrame import FrameSolver
from CrossSectonOptimization.Fixed.Structure import structure
